...
execFileSync(process.execPath, [join(ROOT, 'gen-context.js')], { cwd: ROOT, stdio: 'ignore' });
...
function scoreJvm() {
  ...
  const overrides = JSON.parse(readFileSync(join(ROOT, 'benchmarks', 'config-overrides.json'), 'utf8'));
