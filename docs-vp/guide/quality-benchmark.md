...
description: What token reduction means operationally in v7.25.0. 16/21 repos overflow GPT-4o without SigMap, 5,200+ files would be hidden, and GPT-4o input savings reach $10,500+/month at 10 calls/day.
head:
  - - meta
    - property: og:title
...
::: info Official v7.25.0 benchmark snapshot
**Benchmark ID:** sigmap-v7.25-main &nbsp;·&nbsp; **Date:** 2026-06-21 (with R language)
...
Latest saved run: **2026-06-21 (v7.25.0)**
