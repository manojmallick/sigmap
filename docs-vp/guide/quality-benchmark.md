...
description: What token reduction means operationally in v6.7. 13/18 repos overflow GPT-4o without SigMap, 4,993 files would be hidden, and GPT-4o input savings reach $9,337.58/month at 10 calls/day.
head:
  - - meta
    - property: og:title
...
Latest saved run: **2026-04-30 (v6.7.0)**
