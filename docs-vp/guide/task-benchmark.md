...
description: Latest saved task benchmark for SigMap v8.14.0. 67.8% correct, 49.2% fewer prompts, 88% hit@5 across 90 tasks, with R language support.
head:
  - - meta
    - property: og:title
...
Latest saved run: **2026-07-11 (v8.14.0)** — Now includes R language support (ggplot2, dplyr, shiny)
