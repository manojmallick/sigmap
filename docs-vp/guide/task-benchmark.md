...
description: Latest saved task benchmark for SigMap v7.25.0. 52.2% correct, 39.4% fewer prompts, 76% hit@5 across 90 tasks, with R language support.
head:
  - - meta
    - property: og:title
...
Latest saved run: **2026-06-21 (v7.25.0)** — Now includes R language support (ggplot2, dplyr, shiny)
