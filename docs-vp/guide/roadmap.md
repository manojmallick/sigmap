...
head:
  ...
  - - meta
    - property: og:description
      content: "192 versions shipped. See what changed in each release and what is coming next."
  - - meta
    - property: og:url
...
One hundred eighty-five versions shipped. MIT open source from day one.
