...
head:
  ...
  - - meta
    - property: og:description
      content: "90 versions shipped. See what changed in each release and what is coming next."
  - - meta
    - property: og:url
...
Ninety versions shipped. MIT open source from day one.
