...
head:
  ...
  - - meta
    - property: og:description
      content: "191 versions shipped. See what changed in each release and what is coming next."
  - - meta
    - property: og:url
...
One hundred eighty-four versions shipped. MIT open source from day one.

**Stats:** 96.6% overall token reduction · 78.6% retrieval hit@5 (1.73× measured lift vs single-shot grep) · 98.0% test-discovery F1 · installed-library grounding (JS/TS + Python) · method-level call-graph (JS/TS, Python, Java, Go, Rust, Kotlin, Scala) · 22 MCP tools · 36 languages · 17-language source resolver · 0 npm deps
