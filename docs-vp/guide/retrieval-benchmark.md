...
description: Latest saved retrieval benchmark for SigMap v8.50.0. 78.6% hit@5 vs 44.0% single-shot grep baseline (1.73× honest lift) across 105 tasks on 18 repos, with R language support.
head:
  - - meta
    - property: og:title
