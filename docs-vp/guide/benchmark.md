...
description: Official v8.32.1 benchmark snapshot. 96.8% average token reduction across 21 repos, 78.9% retrieval hit@5, 44.4% fewer prompts, and R language support verified.
head:
  - - meta
    - property: og:title
      content: "SigMap benchmark overview — v8.32.1 snapshot with R language"
  - - meta
    - property: og:description
      content: "Token, retrieval, quality, and task metrics from latest v8.32.1 benchmark run (2026-09-12) with 21 repositories including R language support."
  - - meta
    - property: og:url
...
::: info Official v8.32.1 benchmark snapshot (21 repos, including R language)
...
## Official v8.32.1 snapshot (with R language support)
