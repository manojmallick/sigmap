...
description: Official v7.25.0 benchmark snapshot. 97.0% average token reduction across 21 repos, 76% retrieval hit@5, 39.4% fewer prompts, and R language support verified.
head:
  - - meta
    - property: og:title
      content: "SigMap benchmark overview — v7.25.0 snapshot with R language"
  - - meta
    - property: og:description
      content: "Token, retrieval, quality, and task metrics from latest v7.25.0 benchmark run (2026-06-21) with 21 repositories including R language support."
  - - meta
    - property: og:url
...
::: info Official v7.25.0 benchmark snapshot (21 repos, including R language)
**Benchmark ID:** sigmap-v7.25-main &nbsp;·&nbsp; **Date:** 2026-06-21
...
## Official v7.25.0 snapshot (with R language support)

Latest saved benchmark run: **2026-06-21 (v7.25.0)**
