...
description: SigMap generalizes across 21 repos, 36 languages, and multiple domains with 78.6% hit@5 in the latest saved v8.50.0 retrieval run.
head:
  - - meta
    - property: og:title
...
::: info Official v8.50.0 benchmark snapshot
**Benchmark ID:** sigmap-v8.50-main &nbsp;·&nbsp; **Date:** 2026-09-24 (with R language)
...
these 105 tasks is yes — 78.6% hit@5 with no per-repo tuning in the latest saved v8.50.0 run.
:::
...
If you want one number to carry into launch messaging, use the shared `v8.50.0` snapshot rather than an older per-page variant:
