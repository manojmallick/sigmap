...
description: SigMap generalizes across 21 repos, 31 languages, and multiple domains with 75.6% hit@5 in the latest saved v7.25.0 retrieval run.
head:
  - - meta
    - property: og:title
...
these 90 tasks is yes — 76% hit@5 with no per-repo tuning in the latest saved v7.25.0 run.
:::
