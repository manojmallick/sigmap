...
description: SigMap generalizes across 21 repos, 32 languages, and multiple domains with 78.9% hit@5 in the latest saved v8.32.1 retrieval run.
head:
  - - meta
    - property: og:title
...
these 105 tasks is yes — 78.9% hit@5 with no per-repo tuning in the latest saved v8.32.1 run.
:::
...
If you want one number to carry into launch messaging, use the shared `v8.32.1` snapshot rather than an older per-page variant:
